    ...
    <div className="min-h-screen gradient-bg flex items-center justify-center p-4">
      ...
      <Card className="w-full max-w-md glass-effect border-white/20 animate-fade-in">
        <CardHeader className="text-center space-y-4">
          ...
          <div>
            <CardTitle className="text-2xl font-bold text-white">CEDU Portal</CardTitle>
            <CardDescription className="text-white/80">Access your CEDU dashboard</CardDescription>
          </div>
        </CardHeader>
        <CardContent>
